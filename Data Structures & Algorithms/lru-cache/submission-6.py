...
class LRUCache:
    ...
    def __move(self, to_move: ListNode, behind: ListNode) -> None:
        to_move.backward.forward = to_move.forward
        to_move.forward.backward = to_move.backward
        to_move.backward = behind
        to_move.forward = behind.forward
        behind.forward.backward = to_move
        behind.forward = to_move
