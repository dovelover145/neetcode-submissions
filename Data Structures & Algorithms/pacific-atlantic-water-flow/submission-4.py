class Solution:
    def pacificAtlantic(self, heights: List[List[int]]) -> List[List[int]]:
        ...
        def dfs(r, c, visited, prev_height):
            if 0 <= r < ROWS and 0 <= c < COLS and not (r, c) in visited and prev_height <= heights[r][c]: # Don't need parentheses due to order of operations
                visited.add((r, c)) # Don't forget to add (r, c) to the visited set
